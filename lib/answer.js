...
var _strStandar = _interopRequireDefault(require("./utils/str-standar"));
...
const buildAnswer = async text => {
  const tweetText = (0, _strStandar.default)(text);

  if (tweetText === '') {
    const [movieData, isAPISource] = await (0, _movie.default)();
